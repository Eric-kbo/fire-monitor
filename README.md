...
|   |注销|退出当前登录用户
|   |注册|邀请注册制
|GIS|地图定位|在地图中显示终端设备所在位置，并且展示最新状态
|告警|实时|展示当天终端设备的告警信息及设备状态，及统计正常/异常设备数量
|   |历史|展示过往终端设备的告警信息及设备状态
|数据中心|设备状态|展示当前用户的所有设备状态，根据地域，设备编号及日期进行筛选
...
### 启泰智慧消防APP-预览版-0.0.1～0.0.2（工期13天，费用13天）

* 13天，根据工作计划表的任务量的进行时间的估算（非精确时间）。超过的时间不额外计费，完成后，免费维护2个月。
* 5天，界面修改，功能操作优化。

### 启泰智慧消防APP-预览版-0.0.3～0.1.0（工期7天，费用4+11天）
...
| 启泰智慧消防APP-预览版-0.1.0 | UI兼容平板 | 界面-用户登陆<br />界面-历史数据<br />界面-实时数据<br />界面-告警列表<br />界面-新版本提示 | 4天  | 周兴邦               |
