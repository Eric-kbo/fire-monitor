<template>
  <div>
    ...
    <van-nav-bar title="启泰传感" :left-arrow="getLeft()" @click-left="onClickLeft" @click-right="onClickRight">
      <template #title>
        <div><img style="height: 47px;display: inline-block;max-width: 100%" src="../assets/images/headerLogo.png"/>
        </div>
      </template>
      <template #right>
    ...
    <div style="margin-top: 46px;">
      ...
      <warnings v-show="active == 'warnings'" :model="warningsData" :allCount="warningsAllCount"></warnings>
...
export default {
  ...
  data() {
    return {
      ...
      actions: [{text: '版本1.1.7', disabled: true}, {text: '更新'}, {text: '注销'}],
      //wanings
      warningsData: [],
      warningsAllCount: 0,
      tagDetailData: []
