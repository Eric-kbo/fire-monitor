<template>
	<div style="margin-bottom: 15%">
		...
		<van-row>
			<van-col span="18"><van-field v-model="fieldValue" is-link readonly placeholder="请选择设备" @click="show = true" /></van-col>
			<van-col span="6"><van-button type="info" @click="getRegion" block>查询</van-button></van-col>
		</van-row>
		<van-popup v-model="show" round position="bottom">
			<van-cascader v-model="cascaderValue" title="请选择所在地区" :options="options" @close="show = false" @finish="onFinish" @change="changeFinish" />
		</van-popup>
...
<script>
import { Row, Col, Icon, Cell, CellGroup, Cascader, Field, Popup, Collapse, CollapseItem, Tag, Divider, Card, Search, Button, Picker } from 'vant';
